...
GeneratedDocumentServiceDep = Annotated[GeneratedDocumentService, Depends(GeneratedDocumentService)]

GenerationProcessServiceDep = Annotated[GenerationProcessService, Depends(GenerationProcessService)]

DocumentTemplateServiceDep = Annotated[DocumentTemplateService, Depends(DocumentTemplateService)]
...
DocumentGeneratorServiceDep = Annotated[DocumentGeneratorService, Depends(DocumentGeneratorService)]
